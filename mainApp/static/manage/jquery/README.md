...
```js
import $ from "mainApp/static/manage/jquery/dist/jquery";
```
...
```js
var $ = require("mainApp/static/manage/jquery");
```
...
```js
define(["mainApp/static/manage/jquery"], function ($) {
...
const $ = require("mainApp/static/manage/jquery")(window);
```
